        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              TimerDisplay(
                targetDateTime: DateTime(2025, 4, 16, 09, 04), // Apr 16, 2025 at 9:04 AM
              ),
                  ...
                  RoundedWhiteButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Nakath6Screen(),
                        ),
                      );
                    },
                  ),
                    ...
                    onPressed: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder:
                              (context) =>
                                  const Nakath8Screen(), //change this to the next screen
                        ),
                      );
                    },
                  ),
